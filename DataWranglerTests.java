...
public class DataWranglerTests {
  ...
  /**
   * Generates BridgeDataReaders for Illinois Central and Chicago & Northwestern bridges for all
   * test methods
   */
  @BeforeEach
  ...
  public void testCompareTo() {
    try {
      ...
      assertEquals(1, cnwReader.getBridges().get(12).compareTo(
          new Bridge("Bridge 1450 B", cnwReader.getBridgePrefix(), cnwReader.getNumberDivider())));
      ...
      // searches
      assertEquals(0, cnwReader.getBridges().get(0).compareTo(
          new Bridge("Bridge 1450", cnwReader.getBridgePrefix(), cnwReader.getNumberDivider())));
    } catch (Exception e) {
      fail("No exceptions should be thrown by compareTo method, but an exception was thrown: "
